...
from models import BAPnet, BAPnetTA, BAPnetTANoCls
...
def main(cfg, device, local_rank=0):
    ...
    elif cfg.model == 'bapnetTANoCls':
        model = BAPnetTANoCls(classes=cfg.n_class, encoder_name=cfg.encoder, **cfg.modelTA_cfg)
...
if __name__ == '__main__':
    from configs.remote_config_bapnetTA import Config
